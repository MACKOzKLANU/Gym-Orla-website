...
function MuscleGroup() {
    ...
    // Handle click event for polygons
      ...
      <div class="GroupContainer">
        ...
        >
          ...
          <polygon
            ...
            data-value="biceps"
            className={`hover-effect ${isSelected("biceps") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="forearm"
            className={`hover-effect ${isSelected("forearm") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="quads"
            className={`hover-effect ${isSelected("quads") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="calves"
            className={`hover-effect ${isSelected("calves") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="traps"
            className={`hover-effect ${isSelected("traps") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="rear delts"
            className={`hover-effect ${isSelected("rear delts") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="upper back"
            className={`hover-effect ${isSelected("upper back") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="lats"
            className={`hover-effect ${isSelected("lats") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="triceps"
            className={`hover-effect ${isSelected("triceps") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="forearms"
            className={`hover-effect ${isSelected("forearms") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="lower back"
            className={`hover-effect ${isSelected("lower back") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="glutes"
            className={`hover-effect ${isSelected("glutes") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="hamstring"
            className={`hover-effect ${isSelected("hamstring") ? "selected" : ""}`}
          ...
          <polygon
            ...
            data-value="abs"
            className={`hover-effect ${isSelected("abs") ? "selected" : ""}`}
